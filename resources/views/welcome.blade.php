								...
								<li>
									<div class="cart-item product-summary">
										<div class="row">
											<div class="col-xs-4">
												<div class="image">
													<a href="detail.html"><img src="{!! asset('frontend_assets') !!}/images/cart.jpg" alt=""></a>
												</div>
											</div>
											<div class="col-xs-7">
		...
		<div class="header-nav animate-dropdown">
			...
			<div class="nav-outer">
		       ...
		       <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image">
		           <img class="img-responsive" src="{!! asset('frontend_assets') !!}/images/banners/top-menu-banner.jpg" alt="">
					 </div><!-- /.yamm-content -->
		</div>
		</div>
		    ...
		    <div class="row">
		           <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
		            ...
		            <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
		             ...
		             <a href="#"><img alt="" src="{!! asset('frontend_assets') !!}/images/banners/banner-side.png"></a>
		             </div>
		    </div><!-- /.row -->
		</div><!-- /.yamm-content -->					</li>
						</ul>
				...
				<div class="col-xs-12 col-sm-12 col-md-3 sidebar">
										...
										<div class="item">
												<div class="products">
													<div class="hot-deal-wrapper">
														<div class="image">
															<img src="{!! asset('frontend_assets') !!}/images/hot-deals/p25.jpg" alt="">
														</div>
														...
														<div class="row product-micro-row">
															 ...
															 <div class="col col-xs-5">
																	<div class="product-image">
																		<div class="image">
																			<a href="#">
																				<img src="{!! asset('frontend_assets') !!}/images/products/p30.jpg" alt="">
																			</a>
																		</div><!-- /.image -->
																	</div><!-- /.product-image -->
																</div><!-- /.col -->
					...
					<!-- ============================================== Testimonials============================================== -->
							<div class="sidebar-widget  wow fadeInUp outer-top-vs ">
								<div id="advertisement" class="advertisement">
							        <div class="item">
							            <div class="avatar"><img src="{!! asset('frontend_assets') !!}/images/testimonials/member1.png" alt="Image"></div>
													<div class="testimonials"><em>"</em> Vtae sodales aliq uam morbi non sem lacus port mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em></div>
													<div class="clients_author">John Doe	<span>Abc Company</span>	</div><!-- /.container-fluid -->
							        </div><!-- /.item -->

							       <div class="item">
								         	<div class="avatar"><img src="{!! asset('frontend_assets') !!}/images/testimonials/member3.png" alt="Image"></div>
													<div class="testimonials"><em>"</em>Vtae sodales aliq uam morbi non sem lacus port mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em></div>
					...
					<!-- ============================================== Testimonials: END ============================================== -->
						...
						<div class="home-banner">
							<img src="{!! asset('frontend_assets') !!}/images/banners/LHS-banner.jpg" alt="Image">
						</div>
			...
			<!-- ========================================== SECTION – HERO ========================================= -->
					...
					<div id="hero">
						<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
							...
							<div class="item" style="background-image: url({!! asset('frontend_assets') !!}/images/sliders/01.jpg);">
							...
							<div class="item" style="background-image: url({!! asset('frontend_assets') !!}/images/sliders/02.jpg);">
								<div class="container-fluid">
									<div class="caption bg-color vertical-center text-left">
										...
										<div class="item item-carousel">
											<div class="products">
												...
												<div class="product">
													...
													<div class="product-image">
														<div class="image">
															<a href="detail.html"><img  src="{!! asset('frontend_assets') !!}/images/products/p1.jpg" alt=""></a>
														</div><!-- /.image -->
										...
										<div class="item item-carousel">
											<div class="products">
												...
												<div class="product">
													...
													<div class="product-info text-left">
														<h3 class="name"><a href="detail.html">okkkk Print Buttoned</a></h3>
														<div class="rating rateit-small"></div>
														<div class="description"></div>
														<div class="product-price">
															<span class="price">
						...
						<div class="row">
							<div class="col-md-7 col-sm-7">
								<div class="wide-banner cnt-strip">
									<div class="image">
									<img class="img-responsive" src="{!! asset('frontend_assets') !!}/images/banners/home-banner1.jpg" alt="">
									</div>
							...
							<div class="col-md-5 col-sm-5">
								<div class="wide-banner cnt-strip">
									<div class="image">
									<img class="img-responsive" src="{!! asset('frontend_assets') !!}/images/banners/home-banner2.jpg" alt="">
									</div>
							...
							<div class="item item-carousel">
								<div class="products">
										<div class="product">
											<div class="product-image">
												<div class="image">
													<a href="detail.html"><img  src="{!! asset('frontend_assets') !!}/images/products/p5.jpg" alt=""></a>
												</div><!-- /.image -->
					...
					<div class="wide-banners wow fadeInUp outer-bottom-xs">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="wide-banner cnt-strip">
									<div class="image">
										<img class="img-responsive" src="{!! asset('frontend_assets') !!}/images/banners/home-banner.jpg" alt="">
									</div>
													...
													<div class="row product-micro-row">
														<div class="col col-xs-5">
															<div class="product-image">
																<div class="image">
																	<a href="#">
																		<img src="{!! asset('frontend_assets') !!}/images/products/p20.jpg" alt="">
																	</a>
																</div><!-- /.image -->
															</div><!-- /.product-image -->
														</div><!-- /.col -->
									...
									<div class="item">
										<div class="blog-post">
											<div class="blog-post-image">
												<div class="image">
													<a href="blog.html"><img src="{!! asset('frontend_assets') !!}/images/blog-post/post1.jpg" alt=""></a>
												</div>
											</div><!-- /.blog-post-image -->
						...
						<div class="logo-slider-inner">
							<div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
								<div class="item m-t-15">
									<a href="#" class="image">
										<img data-echo="{!! asset('frontend_assets') !!}/images/brands/brand1.png" src="{!! asset('frontend_assets') !!}/images/blank.gif" alt="">
									</a>
								</div><!--/.item-->

								<div class="item m-t-10">
									<a href="#" class="image">
										<img data-echo="{!! asset('frontend_assets') !!}/images/brands/brand2.png" src="{!! asset('frontend_assets') !!}/images/blank.gif" alt="">
									</a>
								</div><!--/.item-->

								<div class="item">
									<a href="#" class="image">
										<img data-echo="{!! asset('frontend_assets') !!}/images/brands/brand3.png" src="{!! asset('frontend_assets') !!}/images/blank.gif" alt="">
									</a>
								</div><!--/.item-->
...
<!-- ============================================================= FOOTER : END============================================================= -->
    ...
    <script type="text/javascript" src="{!! asset('frontend_assets') !!}/js/lightbox.min.js"></script>
